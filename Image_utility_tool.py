...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton8 = QtWidgets.QPushButton(self.crop_tab)
        self.pushButton8.setGeometry(QtCore.QRect(660, 230, 75, 23))
        ...
        self.horizontalSlider.setGeometry(QtCore.QRect(620, 110, 191, 22))
        self.horizontalSlider.setSingleStep(1)
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.graphicsView = QtWidgets.QGraphicsView(self.duplicate_tab)
        self.graphicsView.setGeometry(QtCore.QRect(620, 210, 256, 192))
        self.graphicsView.setObjectName("graphicsView")
        self.checkBox_2 = QtWidgets.QCheckBox(self.duplicate_tab)
        self.checkBox_2.setGeometry(QtCore.QRect(660, 20, 131, 20))
        self.checkBox_2.setObjectName("checkBox_2")
        self.hist_min = QtWidgets.QLabel(self.duplicate_tab)
        self.hist_min.setGeometry(QtCore.QRect(620, 80, 51, 16))
        self.hist_min.setObjectName("hist_min")
        self.hist_max = QtWidgets.QLabel(self.duplicate_tab)
        self.hist_max.setGeometry(QtCore.QRect(760, 80, 51, 16))
        self.hist_max.setObjectName("hist_max")
        self.hist_value = QtWidgets.QLabel(self.duplicate_tab)
        self.hist_value.setGeometry(QtCore.QRect(830, 110, 51, 16))
        self.hist_value.setObjectName("hist_value")
        self.horizontalSlider_2 = QtWidgets.QSlider(self.duplicate_tab)
        self.horizontalSlider_2.setGeometry(QtCore.QRect(620, 140, 191, 22))
        self.horizontalSlider_2.setProperty("value", 99)
        self.horizontalSlider_2.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_2.setObjectName("horizontalSlider_2")
        self.hist_lower = QtWidgets.QLabel(self.duplicate_tab)
        self.hist_lower.setGeometry(QtCore.QRect(560, 110, 41, 20))
        self.hist_lower.setObjectName("hist_lower")
        self.hist_upper = QtWidgets.QLabel(self.duplicate_tab)
        self.hist_upper.setGeometry(QtCore.QRect(560, 140, 41, 20))
        self.hist_upper.setObjectName("hist_upper")
        self.hist_value_2 = QtWidgets.QLabel(self.duplicate_tab)
        self.hist_value_2.setGeometry(QtCore.QRect(830, 140, 51, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.seek_identical.setText(_translate("MainWindow", "find identical images"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "path 1"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "path 2"))
        self.checkBox_2.setText(_translate("MainWindow", "Enable histogram view"))
