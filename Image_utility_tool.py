...
# Form implementation generated from reading ui file 'C:\Users\doron\Documents\py projects\Image_editor\Image_Editor.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Extractor_prev.setGeometry(QtCore.QRect(260, 630, 75, 23))
        self.Extractor_prev.setObjectName("Extractor_prev")
        self.Extractor_next = QtWidgets.QPushButton(self.image_extractor_tab)
        self.Extractor_next.setGeometry(QtCore.QRect(630, 630, 75, 23))
        ...
        self.seek_identical.setGeometry(QtCore.QRect(40, 30, 131, 31))
        ...
        self.destination_button.setGeometry(QtCore.QRect(930, 80, 171, 23))
        self.destination_button.setObjectName("destination_button")
        self.Source_TextEdit = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.Source_TextEdit.setGeometry(QtCore.QRect(930, 40, 211, 31))
        ...
        self.destination_TextEdit.setGeometry(QtCore.QRect(930, 100, 211, 31))
        ...
        self.source_button.setGeometry(QtCore.QRect(930, 20, 141, 23))
        self.source_button.setObjectName("source_button")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(940, 170, 201, 23))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.Log_listwidget = QtWidgets.QListWidget(self.centralwidget)
        self.Log_listwidget.setGeometry(QtCore.QRect(940, 230, 211, 451))
        self.Log_listwidget.setObjectName("Log_listwidget")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(940, 210, 101, 21))
